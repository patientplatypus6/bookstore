...
cat << EOF > ./src/main/resources/application.properties
  ...
  spring.datasource.NODE_SERVER_URL=node_server
  spring.datasource.NODE_SERVER_PORT=4000

  spring.datasource.REACT_SERVER_URL=react_server
  spring.datasource.REACT_SERVER_PORT=3000
  
  spring.datasource.REACT_CROSSORIGIN=http://react_server:3000
