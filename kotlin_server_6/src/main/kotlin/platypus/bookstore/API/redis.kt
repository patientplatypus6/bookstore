...
suspend fun postredis(key: String, value: String):HashMap<String, String>{
  ...
  val requestaddress:String = "http://"+System.getenv("NODE_SERVER_URL") + ":"+ System.getenv("NODE_SERVER_PORT")+"/store"
...
suspend fun getkeyredis(key: String):HashMap<String, String>{ 
  ...
  val requestaddress:String = "http://"+System.getenv("NODE_SERVER_URL") + ":"+ System.getenv("NODE_SERVER_PORT")+"/retrieve"
  return postrequest(posthash, requestaddress)
}